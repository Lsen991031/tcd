...
root = r"/media/ustc/30d7c9f1-d4ab-497a-b5c2-22e77be472c1/user/ls/mmaction2-master/data/ucf101/rawframes"      # 抽帧后的图片存放目录文件夹，用于写到txt文件中在构建数据集的时候读取

def parse_ucf_splits():
    class_ind = [x.strip().split() for x in open(r'/media/ustc/30d7c9f1-d4ab-497a-b5c2-22e77be472c1/user/ls/mmaction2-master/data/ucf101/annotations')]       # 类别txt
    ...
    splits = []
    for i in range(1, 4):
        train_list = [line2rec(x) for x in open(r'/media/ustc/30d7c9f1-d4ab-497a-b5c2-22e77be472c1/user/ls/mmaction2-master/data/ucf101/annotations/trainlist{:02d}.txt'.format(i))]       # 训练集txt
        test_list = [line2rec(x) for x in open(r'/media/ustc/30d7c9f1-d4ab-497a-b5c2-22e77be472c1/user/ls/mmaction2-master/data/ucf101/annotations/testlist{:02d}.txt'.format(i))]          # 测试集txt
...
f_info = parse_directory(r"media/ustc/30d7c9f1-d4ab-497a-b5c2-22e77be472c1/user/ls/mmaction2-master/data/ucf101/rawframes")    # 存放抽帧后的图片

out_path = r"/media/ustc/30d7c9f1-d4ab-497a-b5c2-22e77be472c1/user/ls/mmaction2-master/data/ucf101"      # 标签路径
dataset = "ucf101"
